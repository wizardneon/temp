...
def parse_games_sync(start_date, end_date):
    return asyncio.run(parse_games(start_date, end_date))


def get_data_sync(start_date, end_date):
    return asyncio.run(get_data(start_date, end_date))
